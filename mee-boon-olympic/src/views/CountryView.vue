...
<template>
  <main class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div v-if="isLoading" class="flex flex-col items-center justify-center min-h-[400px]">
      <div
        class="animate-spin rounded-full h-16 w-16 border-4 border-skin-button-accent border-t-transparent"
      ></div>
    ...
    <div
      v-else-if="country"
      class="bg-skin-fill-alt dark:bg-skin-sec rounded-2xl shadow-lg overflow-hidden"
    >
        ...
        <div class="mt-8 pb-12">
          ...
          <div v-else-if="currentTab === 'sport-list'" class="space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
              <div class="bg-skin-fill dark:bg-skin-fill rounded-2xl p-8 overflow-hidden">
                ...
                <div v-for="sport in country.medals" :key="sport.sportName">
                  <div class="grid grid-cols-3 gap-4">
                    <div class="bg-skin-fill-alt dark:bg-skin-sec rounded-xl p-6 shadow-sm">
                      <div class="text-4xl font-bold text-skin-gold mb-2">
                        {{ sport.goldCount }}
                      </div>
                      <p class="text-sm font-medium text-skin-muted">Gold Medals 🥇</p>
                    </div>
                    <div class="bg-skin-fill-alt dark:bg-skin-sec rounded-xl p-6 shadow-sm">
                      <div class="text-4xl font-bold text-skin-silver mb-2">
                        {{ sport.silverCount }}
                      </div>
                      <p class="text-sm font-medium text-skin-muted">Silver Medals 🥈</p>
                    </div>
                    <div class="bg-skin-fill-alt dark:bg-skin-sec rounded-xl p-6 shadow-sm">
                      <div class="text-4xl font-bold text-skin-bronze mb-2">
                        {{ sport.bronzeCount }}
                      </div>
                    ...
                    <table class="min-w-full divide-y divide-skin-base">
                      <thead class="bg-skin-fill dark:bg-skin-fill">
                        <tr>
                          <th
                            scope="col"
                            class="px-6 py-4 text-left text-xs font-medium text-skin-muted uppercase tracking-wider"
                          >
                            Sport Name
                          </th>
                          <th
                      ...
                      <tbody class="bg-skin-fill-alt dark:bg-skin-sec divide-y divide-skin-base">
                        ...
                        >
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-skin-button-accent">
                              #{{ sport.rankPosition }}
                            </div>
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap">
