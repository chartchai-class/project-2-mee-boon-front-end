...
<template>
  <div class="min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div
        class="mb-8 py-6 sm:py-8 px-6 sm:px-10 bg-skin-fill-alt dark:bg-skin-button-fill rounded-lg"
      >
        <div
        ...
        >
          <div class="">
            ...
            <p class="mt-2 text-sm text-skin-second">
          ...
          <div class="relative w-full sm:w-auto">
            <input
              ...
              class="w-full sm:w-64 pl-10 pr-4 py-2 rounded-lg border border-skin-base bg-skin-fill dark:bg-skin-fill text-skin-base placeholder-skin-muted focus:ring-2 focus:ring-skin-button-accent focus:border-transparent"
            />
            <svg
          ...
          <table class="w-full">
            <thead>
              <tr class="bg-skin-header-table">
                <th
                  class="px-6 py-3 text-left text-xs font-medium text-skin-headTable uppercase tracking-wider w-16"
                >
                  #
                </th>
                <th
                  class="px-6 py-3 text-left text-xs font-medium text-skin-headTable uppercase tracking-wider"
                >
                  Country
                </th>
                <th
                ...
                <th
                  class="px-6 py-3 text-center text-xs font-medium text-skin-headTable uppercase tracking-wider w-24"
                >
                  Total
                </th>
                <th
                  class="px-6 py-3 text-right text-xs font-medium text-skin-headTable uppercase tracking-wider w-32"
                >
                  Actions
                </th>
              </tr>
